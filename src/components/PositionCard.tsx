      ...
      {editing && editForm ? (
        <div className="position-card-edit" onClick={(e) => e.stopPropagation()}>
          <section className="form-section">
            <h4 className="panel-title">1. Pozicioni</h4>
          ...
          <section className="form-section">
            <h4 className="panel-title">2. Kostot</h4>
            <div className="form-grid">
              <label>
                Materiali për njësi (€)
          ...
          <section className="form-section">
            <h4 className="panel-title">3. Marzhet</h4>
            <div className="form-grid">
              <label>
                Fitimi (%)
          ...
          <section className="form-section">
            <h4 className="panel-title">Rregullo drejt një totali synuar</h4>
            <div className="register-target-stack">
              <label>
                Target total (€)
                <input type="number" step="0.01" value={targetTotal} onChange={(e) => setTargetTotal(e.target.value)} placeholder="p.sh. 500" />
              </label>
              <label>
                Mënyra
